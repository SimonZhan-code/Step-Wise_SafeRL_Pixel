...
class WorldModel(tf.Module):
    ...
    def _predict(self, prev_stochastic, prev_deterministic, prev_action):
        ...
        z_t = prior.sample()
        # z_t stands for the stochastic state of the world model
        # d_t stands for the deterministic state of the world model
        # prior is the distribution z_t comes from
