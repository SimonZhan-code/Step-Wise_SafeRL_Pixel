...
class SafetyGymEnv:
    ...
    def reset(self):
        ...
        if self.symbolic:
            ...
            return _images_to_observation(self.render_obs(), self.bit_depth)
    ...
    def step(self, action):
        ...
        if self.symbolic:
            ...
            observation = _images_to_observation(self.render_obs(), self.bit_depth)
        return observation, reward, done, info['cost']
...
def Env(env, symbolic, seed, max_episode_length, action_repeat, bit_depth):
    if env in GYM_ENVS:
        ...
        return SafetyGymEnv(env, symbolic, seed, max_episode_length, action_repeat, bit_depth)
