...
from modules.env import postprocess_observation, preprocess_observation_
...
class ExperienceReplay:
    ...
    def append(self, observation, action, reward, done, cost):
    ...
    def _retrieve_batch(self, idxs, n, L):
        ...
        return (
            ...
            self.costs[vec_idxs].reshape(L, n),
